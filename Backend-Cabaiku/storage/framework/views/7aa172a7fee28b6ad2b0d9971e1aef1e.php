...
<body>
    <nav class="navbar">
        <div class="nav-container">
            <a href="<?php echo e(route('home')); ?>" class="logo">🌶️ Cabai<span>ku</span></a>
            <ul class="nav-links">
            ...
            <div class="nav-buttons">
                <a href="<?php echo e(route('login')); ?>" class="btn btn-login"><i class="fas fa-sign-in-alt" style="margin-right:6px;"></i>Masuk</a>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-register"><i class="fas fa-user-plus" style="margin-right:6px;"></i>Daftar</a>
            </div>
        ...
        <div class="mobile-menu" id="mobileMenu">
            ...
            <div class="nav-buttons">
                <a href="<?php echo e(route('login')); ?>" class="btn btn-login">Masuk</a>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-register">Daftar</a>
            </div>
        </div>
    </nav>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="<?php echo e(route('register')); ?>" class="btn btn-hero btn-hero-primary"><i class="fas fa-rocket" style="margin-right:8px;"></i>Coba Sekarang</a>
    ...
    <section class="cta" id="tentang">
        <div class="cta-content">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn btn-hero btn-hero-primary"><i class="fas fa-user-plus" style="margin-right:8px;"></i>Daftar Sekarang</a>
        </div>
    </section>
...
<?php /**PATH C:\laragon\www\cabaiku\Backend-Cabaiku\resources\views/landing.blade.php ENDPATH**/ ?>