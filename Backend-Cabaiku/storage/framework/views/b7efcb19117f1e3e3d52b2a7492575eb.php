...
<?php if($deteksi->gambar && \Illuminate\Support\Facades\Storage::disk('public')->exists($deteksi->gambar)): ?>
<img src="<?php echo e(asset('storage/'.$deteksi->gambar)); ?>" alt="Foto Deteksi" class="hasil-img">
<?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lapto\Documents\SEMESTER 4\workshop laravel\uas\cabaiku_laravel12\cabaiku\resources\views\pages\deteksi-hasil.blade.php ENDPATH**/ ?>