...
<div class="split">
    ...
    <div class="form-panel">
        <div class="form-inner">
            ...
            <div class="form-sub">Sudah punya akun? <a href="<?php echo e(route('login')); ?>">Masuk di sini</a></div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="switch"><a href="<?php echo e(route('login')); ?>">Masuk ke Cabaiku</a></div>
        </div>
    </div>
</div>
<script>
...
<?php /**PATH C:\Users\lapto\Documents\SEMESTER 4\workshop laravel\uas\cabaiku_laravel12\cabaiku\resources\views\auth\register.blade.php ENDPATH**/ ?>